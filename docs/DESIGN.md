...
| 4 | Boot sequence (§9) enforced with explicit sync points between goroutines, not just documentation | High | Out-of-order startup silently produces permanently-misclassified flows |

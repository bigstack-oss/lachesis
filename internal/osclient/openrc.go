// openrc.go parses admin-openrc-style credential files into
// [Credentials]. Moved verbatim from internal/neutron — the parsing
// contract (and its tests) predate this package and must not drift.

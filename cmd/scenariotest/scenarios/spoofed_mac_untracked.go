...
func spoofedMACUntracked() *scenariotest.Scenario {
	...
	return &scenariotest.Scenario{
		...
		Steps: []scenariotest.Step{
			steps.AttachPortStep{VM: "vm-a", ID: "vm-a-forge",
				Network: "net-iso", Subnet: "sub-iso", IP: "10.0.32.9",
				PortSecurityOff: true},
			steps.ConfigureNICStep{VM: "vm-a", Dev: "eth1", CIDR: "10.0.32.9/24"},
			steps.CaptureStep{},
			steps.SetNICMACStep{VM: "vm-a", Dev: "eth1", MAC: "02:de:ad:be:ef:01"},
			...
			steps.ZoneGrowthStep{Tenant: "T1", Zone: "shared", Direction: "tx",
